...
/**
 * Internal Frame que contiene los elementos para insertar datos a la tabla de usuarios
 * @author Unax
 */
public class InternalFrameUsuarios extends InternalFrame {
	
	/**
	 * Constructor del internal frame para insertar datos en la tabla de usuarios
	 */
